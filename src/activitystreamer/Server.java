...
public class Server {
	...
	public static void main(String[] args) {
		...
		//If this server does not connect to any server, it will print out its secret to the console
		if (Settings.getRemoteHostname()==null){
		    log.info("This server starts alone, the secret for this server is:" + Settings.getSecret());
		}
